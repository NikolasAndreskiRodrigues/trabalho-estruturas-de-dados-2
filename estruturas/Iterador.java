...
public class Iterador {
    ...
    public void inserirAposAtual(int dado) {
        ...
        novoNo.proximo = getProximo();
    
        if (haProximo()) {
            getProximo().anterior = novoNo;
        }
    ...
    public void inserirAntesAtual(int dado) {
        ...
        novoNo.anterior = getAnterior();
    
        if (haAnterior() == false) {
            this.lista.inicio = novoNo;
        } else {
            getAnterior().proximo = novoNo;
        }
